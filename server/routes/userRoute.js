...
const { registerUser, loginUser, getUserDetails, getUsers, addTrainerByAdmin, verifyTokenAndRole, logoutUser, addCourseToUser, loginUserDetail, verifyToken, deleteUser } = require("../controller/userController");
